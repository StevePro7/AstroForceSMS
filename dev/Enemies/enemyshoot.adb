M:enemyshoot
F:G$InitEnemyshootSprites$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitEnemyshootDirection$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.InitEnemyshootDirection$x$1$87({1}SC:U),B,1,4
S:Lenemyshoot.InitEnemyshootDirection$y$1$87({1}SC:U),B,1,5
S:Lenemyshoot.InitEnemyshootDirection$vx$1$87({1}SC:S),B,1,6
S:Lenemyshoot.InitEnemyshootDirection$vy$1$87({1}SC:S),B,1,7
S:Lenemyshoot.InitEnemyshootDirection$es$1$88({2}DG,STenemyshoot:S),R,0,0,[c,b]
F:G$SpreadEnemyshootDirection$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.SpreadEnemyshootDirection$x$1$90({1}SC:U),B,1,4
S:Lenemyshoot.SpreadEnemyshootDirection$y$1$90({1}SC:U),B,1,5
S:Lenemyshoot.SpreadEnemyshootDirection$vx$1$90({2}DG,SC:S),B,1,6
S:Lenemyshoot.SpreadEnemyshootDirection$vy$1$90({2}DG,SC:S),B,1,8
S:Lenemyshoot.SpreadEnemyshootDirection$count$1$90({1}SC:U),B,1,10
S:Lenemyshoot.SpreadEnemyshootDirection$a$1$91({1}SC:U),R,0,0,[c]
F:G$InitEnemyshootLaser$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.InitEnemyshootLaser$x$1$93({1}SC:U),B,1,4
S:Lenemyshoot.InitEnemyshootLaser$y$1$93({1}SC:U),B,1,5
S:Lenemyshoot.InitEnemyshootLaser$es$1$94({2}DG,STenemyshoot:S),R,0,0,[c,b]
F:G$InitEnemyshoot$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lenemyshoot.InitEnemyshoot$x$1$96({1}SC:U),B,1,4
S:Lenemyshoot.InitEnemyshoot$y$1$96({1}SC:U),B,1,5
S:Lenemyshoot.InitEnemyshoot$forced$1$96({1}SC:U),B,1,6
S:Lenemyshoot.InitEnemyshoot$dx$1$97({2}SI:S),R,0,0,[c,b]
S:Lenemyshoot.InitEnemyshoot$dy$1$97({2}SI:S),R,0,0,[l,h]
S:Lenemyshoot.InitEnemyshoot$dm$1$97({2}SI:S),R,0,0,[e,d]
S:Lenemyshoot.InitEnemyshoot$es$1$97({2}DG,STenemyshoot:S),B,1,-4
S:Lenemyshoot.InitEnemyshoot$sloc0$1$0({2}SI:S),B,1,-2
F:G$CheckMapCollision$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lenemyshoot.CheckMapCollision$x$1$101({1}SC:U),B,1,4
S:Lenemyshoot.CheckMapCollision$y$1$101({1}SC:U),B,1,5
F:G$RemoveEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.RemoveEnemyshoot$a$1$104({1}SC:S),B,1,4
S:Lenemyshoot.RemoveEnemyshoot$esa$1$105({2}DG,STenemyshoot:S),R,0,0,[c,b]
S:Lenemyshoot.RemoveEnemyshoot$esb$1$105({2}DG,STenemyshoot:S),R,0,0,[]
F:G$UpdateEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.UpdateEnemyshoot$a$1$107({2}SI:U),B,1,4
S:Lenemyshoot.UpdateEnemyshoot$es$1$108({2}DG,STenemyshoot:S),R,0,0,[c,b]
...
S:Lenemyshoot.UpdateEnemyshoots$a$1$112({1}SC:S),R,0,0,[]
F:G$InitEnemyshoots$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$KillEnemyshoots$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$TestEnemyShoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShoot$en$1$116({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShoot$freq$1$116({1}SC:U),B,1,6
F:G$TestEnemyShootOne$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootOne$en$1$118({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootOne$freq$1$118({1}SC:U),B,1,6
F:G$TestEnemyShootComplex$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootComplex$en$1$120({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootComplex$freq$1$120({1}SC:U),B,1,6
S:Lenemyshoot.TestEnemyShootComplex$dx$1$120({1}SC:U),B,1,7
S:Lenemyshoot.TestEnemyShootComplex$dy$1$120({1}SC:U),B,1,8
T:Fenemyshoot$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$enemy[({0}S:S$enemyposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemytype$0$0({1}SC:U),Z,0,0)({3}S:S$enemyframe$0$0({1}SC:U),Z,0,0)({4}S:S$enemyparama$0$0({1}SC:U),Z,0,0)({5}S:S$enemyparamb$0$0({1}SC:U),Z,0,0)({6}S:S$enemyenergy$0$0({1}SC:U),Z,0,0)({7}S:S$enemywidth$0$0({1}SC:U),Z,0,0)({8}S:S$enemyheight$0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fenemyshoot$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fenemyshoot$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
