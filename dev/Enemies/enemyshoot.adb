...
F:G$InitEnemyshoot$0$0({2}DF,SV:S),C,0,2,0,0,0
S:Lenemyshoot.InitEnemyshoot$x$1$69({1}SC:U),B,1,4
S:Lenemyshoot.InitEnemyshoot$y$1$69({1}SC:U),B,1,5
S:Lenemyshoot.InitEnemyshoot$forced$1$69({1}SC:U),B,1,6
S:Lenemyshoot.InitEnemyshoot$dx$1$70({2}SI:S),R,0,0,[c,b]
S:Lenemyshoot.InitEnemyshoot$dy$1$70({2}SI:S),R,0,0,[l,h]
S:Lenemyshoot.InitEnemyshoot$dm$1$70({2}SI:S),R,0,0,[e,d]
S:Lenemyshoot.InitEnemyshoot$es$1$70({2}DG,STenemyshoot:S),B,1,-4
S:Lenemyshoot.InitEnemyshoot$sloc0$1$0({2}SI:S),B,1,-2
F:G$CheckMapCollision$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lenemyshoot.CheckMapCollision$x$1$74({1}SC:U),B,1,4
S:Lenemyshoot.CheckMapCollision$y$1$74({1}SC:U),B,1,5
F:G$RemoveEnemyshoot$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lenemyshoot.RemoveEnemyshoot$a$1$77({1}SC:S),B,1,4
S:Lenemyshoot.RemoveEnemyshoot$esa$1$78({2}DG,STenemyshoot:S),R,0,0,[c,b]
S:Lenemyshoot.RemoveEnemyshoot$esb$1$78({2}DG,STenemyshoot:S),R,0,0,[]
F:G$UpdateEnemyshoot$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lenemyshoot.UpdateEnemyshoot$a$1$80({2}SI:U),B,1,4
S:Lenemyshoot.UpdateEnemyshoot$es$1$81({2}DG,STenemyshoot:S),R,0,0,[c,b]
...
S:Lenemyshoot.UpdateEnemyshoots$a$1$85({1}SC:S),R,0,0,[]
...
S:Lenemyshoot.TestEnemyShoot$en$1$89({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShoot$freq$1$89({1}SC:U),B,1,6
F:G$TestEnemyShootOne$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootOne$en$1$91({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootOne$freq$1$91({1}SC:U),B,1,6
F:G$TestEnemyShootComplex$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootComplex$en$1$93({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootComplex$freq$1$93({1}SC:U),B,1,6
S:Lenemyshoot.TestEnemyShootComplex$dx$1$93({1}SC:U),B,1,7
S:Lenemyshoot.TestEnemyShootComplex$dy$1$93({1}SC:U),B,1,8
...
S:G$InitEnemyshoot$0$0({2}DF,SV:S),C,0,2
