...
S:Lenemyshoot.CheckMapCollision$x$1$107({1}SC:U),B,1,4
S:Lenemyshoot.CheckMapCollision$y$1$107({1}SC:U),B,1,5
F:G$RemoveEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.RemoveEnemyshoot$a$1$110({1}SC:S),B,1,4
S:Lenemyshoot.RemoveEnemyshoot$esa$1$111({2}DG,STenemyshoot:S),R,0,0,[c,b]
S:Lenemyshoot.RemoveEnemyshoot$esb$1$111({2}DG,STenemyshoot:S),R,0,0,[]
F:G$UpdateEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.UpdateEnemyshoot$a$1$113({2}SI:U),B,1,4
S:Lenemyshoot.UpdateEnemyshoot$es$1$114({2}DG,STenemyshoot:S),R,0,0,[c,b]
...
S:Lenemyshoot.UpdateEnemyshoots$a$1$120({1}SC:S),R,0,0,[]
