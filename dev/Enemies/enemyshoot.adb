M:enemyshoot
F:G$enemyshoot_foo$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitEnemyshootSprites$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitEnemyshoots$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Fenemyshoot$enemy[({0}S:S$enemyposx$0_0$0({1}SC:U),Z,0,0)({1}S:S$enemyposy$0_0$0({1}SC:U),Z,0,0)({2}S:S$enemytype$0_0$0({1}SC:U),Z,0,0)({3}S:S$enemyframe$0_0$0({1}SC:U),Z,0,0)({4}S:S$enemyparama$0_0$0({1}SC:U),Z,0,0)({5}S:S$enemyparamb$0_0$0({1}SC:U),Z,0,0)({6}S:S$enemyenergy$0_0$0({1}SC:U),Z,0,0)({7}S:S$enemywidth$0_0$0({1}SC:U),Z,0,0)({8}S:S$enemyheight$0_0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$enemyshoot[({0}S:S$enemyshootposx$0_0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0_0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0_0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0_0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0_0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$scroll[({0}S:S$scrolllock$0_0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0_0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0_0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0_0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0_0$0({2}SI:S),Z,0,0)]
T:Fenemyshoot$script[({0}S:S$scripterpass$0_0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0_0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0_0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0_0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0_0$0({1}SC:S),Z,0,0)]
T:Fenemyshoot$playershoot[({0}S:S$playershootx$0_0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0_0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0_0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0_0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0_0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$explosion[({0}S:S$explosionposx$0_0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0_0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0_0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0_0$0({1}SC:U),Z,0,0)]
T:Fenemyshoot$timeredlabel[({0}S:S$timeredlabely$0_0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0_0$0({1}SC:U),Z,0,0)]
