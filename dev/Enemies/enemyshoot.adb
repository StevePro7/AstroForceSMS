...
S:Lenemyshoot.CheckMapCollision$x$1$104({1}SC:U),B,1,4
S:Lenemyshoot.CheckMapCollision$y$1$104({1}SC:U),B,1,5
F:G$RemoveEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.RemoveEnemyshoot$a$1$107({1}SC:S),B,1,4
S:Lenemyshoot.RemoveEnemyshoot$esa$1$108({2}DG,STenemyshoot:S),R,0,0,[c,b]
S:Lenemyshoot.RemoveEnemyshoot$esb$1$108({2}DG,STenemyshoot:S),R,0,0,[]
F:G$UpdateEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.UpdateEnemyshoot$a$1$110({2}SI:U),B,1,4
S:Lenemyshoot.UpdateEnemyshoot$es$1$111({2}DG,STenemyshoot:S),R,0,0,[c,b]
...
S:Lenemyshoot.UpdateEnemyshoots$a$1$117({1}SC:S),R,0,0,[]
...
S:Lenemyshoot.TestEnemyShoot$en$1$121({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShoot$freq$1$121({1}SC:U),B,1,6
F:G$TestEnemyShootOne$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootOne$en$1$123({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootOne$freq$1$123({1}SC:U),B,1,6
F:G$TestEnemyShootComplex$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootComplex$en$1$125({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootComplex$freq$1$125({1}SC:U),B,1,6
S:Lenemyshoot.TestEnemyShootComplex$dx$1$125({1}SC:U),B,1,7
S:Lenemyshoot.TestEnemyShootComplex$dy$1$125({1}SC:U),B,1,8
