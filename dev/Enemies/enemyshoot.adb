...
S:Lenemyshoot.InitEnemyshootDirection$x$1$75({1}SC:U),B,1,4
S:Lenemyshoot.InitEnemyshootDirection$y$1$75({1}SC:U),B,1,5
S:Lenemyshoot.InitEnemyshootDirection$vx$1$75({1}SC:S),B,1,6
S:Lenemyshoot.InitEnemyshootDirection$vy$1$75({1}SC:S),B,1,7
S:Lenemyshoot.InitEnemyshootDirection$es$1$76({2}DG,STenemyshoot:S),R,0,0,[c,b]
F:G$SpreadEnemyshootDirection$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.SpreadEnemyshootDirection$x$1$78({1}SC:U),B,1,4
S:Lenemyshoot.SpreadEnemyshootDirection$y$1$78({1}SC:U),B,1,5
S:Lenemyshoot.SpreadEnemyshootDirection$vx$1$78({2}DG,SC:S),B,1,6
S:Lenemyshoot.SpreadEnemyshootDirection$vy$1$78({2}DG,SC:S),B,1,8
S:Lenemyshoot.SpreadEnemyshootDirection$count$1$78({1}SC:U),B,1,10
S:Lenemyshoot.SpreadEnemyshootDirection$a$1$79({1}SC:U),R,0,0,[c]
F:G$InitEnemyshootLaser$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.InitEnemyshootLaser$x$1$81({1}SC:U),B,1,4
S:Lenemyshoot.InitEnemyshootLaser$y$1$81({1}SC:U),B,1,5
S:Lenemyshoot.InitEnemyshootLaser$es$1$82({2}DG,STenemyshoot:S),R,0,0,[c,b]
F:G$InitEnemyshoot$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lenemyshoot.InitEnemyshoot$x$1$84({1}SC:U),B,1,4
S:Lenemyshoot.InitEnemyshoot$y$1$84({1}SC:U),B,1,5
S:Lenemyshoot.InitEnemyshoot$forced$1$84({1}SC:U),B,1,6
S:Lenemyshoot.InitEnemyshoot$dx$1$85({2}SI:S),R,0,0,[c,b]
S:Lenemyshoot.InitEnemyshoot$dy$1$85({2}SI:S),R,0,0,[l,h]
S:Lenemyshoot.InitEnemyshoot$dm$1$85({2}SI:S),R,0,0,[e,d]
S:Lenemyshoot.InitEnemyshoot$es$1$85({2}DG,STenemyshoot:S),B,1,-4
S:Lenemyshoot.InitEnemyshoot$sloc0$1$0({2}SI:S),B,1,-2
F:G$CheckMapCollision$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lenemyshoot.CheckMapCollision$x$1$89({1}SC:U),B,1,4
S:Lenemyshoot.CheckMapCollision$y$1$89({1}SC:U),B,1,5
F:G$RemoveEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.RemoveEnemyshoot$a$1$92({1}SC:S),B,1,4
S:Lenemyshoot.RemoveEnemyshoot$esa$1$93({2}DG,STenemyshoot:S),R,0,0,[c,b]
S:Lenemyshoot.RemoveEnemyshoot$esb$1$93({2}DG,STenemyshoot:S),R,0,0,[]
F:G$UpdateEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.UpdateEnemyshoot$a$1$95({2}SI:U),B,1,4
S:Lenemyshoot.UpdateEnemyshoot$es$1$96({2}DG,STenemyshoot:S),R,0,0,[c,b]
...
S:Lenemyshoot.UpdateEnemyshoots$a$1$100({1}SC:S),R,0,0,[]
...
S:Lenemyshoot.TestEnemyShoot$en$1$104({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShoot$freq$1$104({1}SC:U),B,1,6
F:G$TestEnemyShootOne$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootOne$en$1$106({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootOne$freq$1$106({1}SC:U),B,1,6
F:G$TestEnemyShootComplex$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.TestEnemyShootComplex$en$1$108({2}DG,STenemy:S),B,1,4
S:Lenemyshoot.TestEnemyShootComplex$freq$1$108({1}SC:U),B,1,6
S:Lenemyshoot.TestEnemyShootComplex$dx$1$108({1}SC:U),B,1,7
S:Lenemyshoot.TestEnemyShootComplex$dy$1$108({1}SC:U),B,1,8
