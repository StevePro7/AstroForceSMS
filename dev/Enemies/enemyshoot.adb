...
S:Lenemyshoot.CheckMapCollision$x$1$99({1}SC:U),B,1,4
S:Lenemyshoot.CheckMapCollision$y$1$99({1}SC:U),B,1,5
F:G$RemoveEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.RemoveEnemyshoot$a$1$102({1}SC:S),B,1,4
S:Lenemyshoot.RemoveEnemyshoot$esa$1$103({2}DG,STenemyshoot:S),R,0,0,[c,b]
S:Lenemyshoot.RemoveEnemyshoot$esb$1$103({2}DG,STenemyshoot:S),R,0,0,[]
F:G$UpdateEnemyshoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemyshoot.UpdateEnemyshoot$a$1$105({2}SI:U),B,1,4
S:Lenemyshoot.UpdateEnemyshoot$es$1$106({2}DG,STenemyshoot:S),R,0,0,[c,b]
