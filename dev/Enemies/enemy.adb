...
S:Lenemy.RemoveEnemy$a$1$21({1}SC:S),B,1,4
S:Lenemy.RemoveEnemy$ea$1$22({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.RemoveEnemy$eb$1$22({2}DG,STenemy:S),R,0,0,[]
F:G$UpdateEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemy$a$1$24({1}SC:U),B,1,4
S:Lenemy.UpdateEnemy$erase$1$25({1}SC:U),B,1,-1
S:Lenemy.UpdateEnemy$en$1$25({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.UpdateEnemy$sloc0$1$0({1}SC:U),B,1,-1
F:G$UpdateEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemies$q$1$27({1}SC:S),R,0,0,[]
F:G$InitEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.InitEnemy$x$1$30({1}SC:U),B,1,4
S:Lenemy.InitEnemy$y$1$30({1}SC:U),B,1,5
S:Lenemy.InitEnemy$t$1$30({1}SC:U),B,1,6
S:Lenemy.InitEnemy$en$1$31({2}DG,STenemy:S),R,0,0,[c,b]
