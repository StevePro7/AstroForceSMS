...
S:Lenemy.GetEnemyDirection$dy$1$55({2}SI:S),R,0,0,[l,h]
S:Lenemy.GetEnemyDirection$dm$1$55({2}SI:S),R,0,0,[e,d]
...
S:Lenemy.RemoveEnemy$a$1$56({1}SC:S),B,1,4
S:Lenemy.RemoveEnemy$ea$1$57({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.RemoveEnemy$eb$1$57({2}DG,STenemy:S),R,0,0,[]
F:G$KillEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.KillEnemy$a$1$59({1}SC:U),B,1,4
S:Lenemy.KillEnemy$en$1$60({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.KillEnemy$t$1$60({1}SC:U),R,0,0,[l]
S:Lenemy.KillEnemy$sloc0$1$0({1}SC:U),B,1,-1
F:G$KillEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.KillEnemies$force$1$62({1}SC:U),B,1,4
S:Lenemy.KillEnemies$a$1$63({1}SC:S),R,0,0,[]
F:G$UpdateEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemy$a$1$65({1}SC:U),B,1,4
S:Lenemy.UpdateEnemy$erase$1$66({1}SC:U),B,1,-1
S:Lenemy.UpdateEnemy$en$1$66({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.UpdateEnemy$sloc0$1$0({1}SC:U),B,1,-1
F:G$UpdateEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemies$q$1$68({1}SC:S),R,0,0,[]
F:G$InitEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.InitEnemy$x$1$71({1}SC:U),B,1,4
S:Lenemy.InitEnemy$y$1$71({1}SC:U),B,1,5
S:Lenemy.InitEnemy$t$1$71({1}SC:U),B,1,6
S:Lenemy.InitEnemy$en$1$72({2}DG,STenemy:S),R,0,0,[c,b]
