...
S:Lenemy.RemoveEnemy$a$1$22({1}SC:S),B,1,4
S:Lenemy.RemoveEnemy$ea$1$23({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.RemoveEnemy$eb$1$23({2}DG,STenemy:S),R,0,0,[]
F:G$UpdateEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemy$a$1$25({1}SC:U),B,1,4
S:Lenemy.UpdateEnemy$erase$1$26({1}SC:U),B,1,-1
S:Lenemy.UpdateEnemy$en$1$26({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.UpdateEnemy$sloc0$1$0({1}SC:U),B,1,-1
F:G$UpdateEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemies$q$1$28({1}SC:S),R,0,0,[]
F:G$InitEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.InitEnemy$x$1$31({1}SC:U),B,1,4
S:Lenemy.InitEnemy$y$1$31({1}SC:U),B,1,5
S:Lenemy.InitEnemy$t$1$31({1}SC:U),B,1,6
S:Lenemy.InitEnemy$en$1$32({2}DG,STenemy:S),R,0,0,[c,b]
