...
S:Lenemy.checkEnemyPlayerShoot$en$1$50({2}DG,STenemy:S),B,1,4
S:Lenemy.checkEnemyPlayerShoot$ps$1$50({2}DG,STplayershoot:S),B,1,6
...
S:Lenemy.GetEnemyDirection$en$1$52({2}DG,STenemy:S),B,1,4
...
S:Lenemy.RemoveEnemy$eb$1$55({2}DG,STenemy:S),R,0,0,[]
F:G$KillEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.KillEnemy$a$1$57({1}SC:U),B,1,4
S:Lenemy.KillEnemy$en$1$58({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.KillEnemy$t$1$58({1}SC:U),R,0,0,[l]
S:Lenemy.KillEnemy$sloc0$1$0({1}SC:U),B,1,-1
F:G$KillEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.KillEnemies$force$1$60({1}SC:U),B,1,4
S:Lenemy.KillEnemies$a$1$61({1}SC:S),R,0,0,[]
F:G$UpdateEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemy$a$1$63({1}SC:U),B,1,4
S:Lenemy.UpdateEnemy$erase$1$64({1}SC:U),B,1,-1
S:Lenemy.UpdateEnemy$en$1$64({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.UpdateEnemy$sloc0$1$0({1}SC:U),B,1,-1
F:G$UpdateEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemies$q$1$66({1}SC:S),R,0,0,[]
F:G$InitEnemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.InitEnemy$x$1$69({1}SC:U),B,1,4
