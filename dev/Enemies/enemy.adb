M:enemy
F:G$enemy_foo$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$RemoveEnemy$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.RemoveEnemy$a$1_0$23({1}SC:S),B,1,4
S:Lenemy.RemoveEnemy$ea$1_0$24({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.RemoveEnemy$eb$1_0$24({2}DG,STenemy:S),B,1,-2
S:Lenemy.RemoveEnemy$sloc0$0_1$0({2}DG,STenemy:S),B,1,-2
F:G$UpdateEnemy$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemy$a$1_0$26({1}SC:U),B,1,4
S:Lenemy.UpdateEnemy$erase$1_0$27({1}SC:U),B,1,-1
S:Lenemy.UpdateEnemy$en$1_0$27({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.UpdateEnemy$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$UpdateEnemies$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemies$q$1_0$29({1}SC:S),R,0,0,[]
F:G$InitEnemy$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.InitEnemy$x$1_0$32({1}SC:U),B,1,4
S:Lenemy.InitEnemy$y$1_0$32({1}SC:U),B,1,5
S:Lenemy.InitEnemy$t$1_0$32({1}SC:U),B,1,6
S:Lenemy.InitEnemy$en$1_0$33({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.InitEnemy$sloc0$0_1$0({1}SC:U),B,1,-2
S:Lenemy.InitEnemy$sloc1$0_1$0({1}SC:U),B,1,-1
F:G$InitEnemies$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Fenemy$enemy[({0}S:S$enemyposx$0_0$0({1}SC:U),Z,0,0)({1}S:S$enemyposy$0_0$0({1}SC:U),Z,0,0)({2}S:S$enemytype$0_0$0({1}SC:U),Z,0,0)({3}S:S$enemyframe$0_0$0({1}SC:U),Z,0,0)({4}S:S$enemyparama$0_0$0({1}SC:U),Z,0,0)({5}S:S$enemyparamb$0_0$0({1}SC:U),Z,0,0)({6}S:S$enemyenergy$0_0$0({1}SC:U),Z,0,0)({7}S:S$enemywidth$0_0$0({1}SC:U),Z,0,0)({8}S:S$enemyheight$0_0$0({1}SC:U),Z,0,0)]
T:Fenemy$enemyshoot[({0}S:S$enemyshootposx$0_0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0_0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0_0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0_0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0_0$0({1}SC:U),Z,0,0)]
T:Fenemy$scroll[({0}S:S$scrolllock$0_0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0_0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0_0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0_0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0_0$0({2}SI:S),Z,0,0)]
T:Fenemy$script[({0}S:S$scripterpass$0_0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0_0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0_0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0_0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0_0$0({1}SC:S),Z,0,0)]
T:Fenemy$playershoot[({0}S:S$playershootx$0_0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0_0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0_0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0_0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0_0$0({1}SC:U),Z,0,0)]
T:Fenemy$explosion[({0}S:S$explosionposx$0_0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0_0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0_0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0_0$0({1}SC:U),Z,0,0)]
T:Fenemy$timeredlabel[({0}S:S$timeredlabely$0_0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0_0$0({1}SC:U),Z,0,0)]
