...
S:Lenemy.checkEnemyPlayerShoot$en$1$75({2}DG,STenemy:S),B,1,4
S:Lenemy.checkEnemyPlayerShoot$ps$1$75({2}DG,STplayershoot:S),B,1,6
...
S:Lenemy.UpdateEnemy$a$1$77({1}SC:U),B,1,4
S:Lenemy.UpdateEnemy$erase$1$78({1}SC:U),B,1,-1
S:Lenemy.UpdateEnemy$en$1$78({2}DG,STenemy:S),R,0,0,[c,b]
S:Lenemy.UpdateEnemy$sloc0$1$0({1}SC:U),B,1,-1
F:G$UpdateEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy.UpdateEnemies$q$1$83({1}SC:S),R,0,0,[]
