...
S:Lspaceshooter.UpdateSpaceShooter$sloc0$1$0({2}DG,SC:U),B,1,-4
S:Lspaceshooter.UpdateSpaceShooter$sloc1$1$0({1}SC:U),B,1,-6
S:Lspaceshooter.UpdateSpaceShooter$sloc2$1$0({1}SC:U),B,1,-5
S:Lspaceshooter.UpdateSpaceShooter$sloc3$1$0({2}SI:S),B,1,-8
S:Lspaceshooter.UpdateSpaceShooter$sloc4$1$0({2}SI:S),B,1,-2
