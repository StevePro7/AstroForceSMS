...
S:Lfuncs.DoSkullSinusMovement$sloc0$1$0({2}DG,STenemy:S),B,1,-8
S:Lfuncs.DoSkullSinusMovement$sloc1$1$0({2}DG,SC:U),B,1,-6
S:Lfuncs.DoSkullSinusMovement$sloc2$1$0({1}SC:U),B,1,-1
S:Lfuncs.DoSkullSinusMovement$sloc3$1$0({1}SC:U),B,1,-2
S:Lfuncs.DoSkullSinusMovement$sloc4$1$0({2}SI:S),B,1,-4
...
S:Lfuncs.DoAracPatternMovement$sloc1$1$0({1}SC:U),B,1,-1
S:Lfuncs.DoAracPatternMovement$sloc2$1$0({1}SC:U),B,1,-2
