...
S:Lfuncs.DoSkullSinusMovement$sloc4$1$0({2}SI:S),B,1,-6
...
S:Lfuncs.DoAracPatternMovement$sloc1$1$0({1}SC:U),B,1,-3
S:Lfuncs.DoAracPatternMovement$sloc2$1$0({1}SC:U),B,1,-4
