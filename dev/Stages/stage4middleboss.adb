M:stage4middleboss
F:G$UpdateStage4MiddleBoss1$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4middleboss.UpdateStage4MiddleBoss1$en$1$63({2}DG,STenemy:S),B,1,4
S:Lstage4middleboss.UpdateStage4MiddleBoss1$p$1$64({2}SI:S),R,0,0,[e,d]
S:Lstage4middleboss.UpdateStage4MiddleBoss1$c$1$64({1}SC:U),R,0,0,[d]
S:Lstage4middleboss.UpdateStage4MiddleBoss1$sloc0$1$0({2}DG,SC:U),B,1,-2
F:G$UpdateStage4MiddleBoss2$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4middleboss.UpdateStage4MiddleBoss2$en$1$66({2}DG,STenemy:S),B,1,4
F:G$UpdateStage4MiddleBoss3$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4middleboss.UpdateStage4MiddleBoss3$en$1$68({2}DG,STenemy:S),B,1,4
S:Lstage4middleboss.UpdateStage4MiddleBoss3$sloc0$1$0({2}SI:S),B,1,-5
S:Lstage4middleboss.UpdateStage4MiddleBoss3$sloc1$1$0({2}SI:S),B,1,-3
S:Lstage4middleboss.UpdateStage4MiddleBoss3$sloc2$1$0({1}SC:U),B,1,-1
F:G$UpdateStage4MiddleBoss4$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4middleboss.UpdateStage4MiddleBoss4$en$1$72({2}DG,STenemy:S),B,1,4
F:G$FinishStage4MiddleBoss$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$UpdateStage4MiddleBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage4middleboss.UpdateStage4MiddleBoss$en$1$76({2}DG,STenemy:S),B,1,4
T:Fstage4middleboss$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
...
T:Fstage4middleboss$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fstage4middleboss$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage4middleboss$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage4middleboss$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage4middleboss$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage4middleboss$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
