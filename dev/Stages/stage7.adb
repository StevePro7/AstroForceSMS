M:stage7
F:G$CheckStage7PlayerMovement$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage7.CheckStage7PlayerMovement$ny$1$82({2}SI:U),R,0,0,[c,b]
S:Lstage7.CheckStage7PlayerMovement$l$1$82({1}SC:U),R,0,0,[e]
S:Lstage7.CheckStage7PlayerMovement$m$1$82({1}SC:U),R,0,0,[c]
S:Lstage7.CheckStage7PlayerMovement$nl$1$82({2}SI:U),R,0,0,[c,b]
F:G$UpdateStage7$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage7.UpdateStage7$sf$1$84({2}SI:U),R,0,0,[l,h]
F:G$InitStage7$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$CheckCollisionStage7$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage7.CheckCollisionStage7$x$1$87({1}SC:U),B,1,4
S:Lstage7.CheckCollisionStage7$y$1$87({1}SC:U),B,1,5
T:Fstage7$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
...
T:Fstage7$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fstage7$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage7$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage7$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage7$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage7$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
