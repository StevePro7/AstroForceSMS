...
S:Lstage8bossc.InitStage8BossC$en$1$85({2}DG,STenemy:S),B,1,4
F:G$FinishStage8BossC$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$UpdateStage8BossC$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage8bossc.UpdateStage8BossC$en$1$89({2}DG,STenemy:S),B,1,4
S:Lstage8bossc.UpdateStage8BossC$a$1$90({1}SC:U),R,0,0,[e]
S:Lstage8bossc.UpdateStage8BossC$sloc0$1$0({2}DG,SC:U),B,1,-2
S:Lstage8bossc.UpdateStage8BossC$sloc1$1$0({1}SC:U),B,1,-4
S:Lstage8bossc.UpdateStage8BossC$sloc2$1$0({1}SC:U),B,1,-3
...
T:Fstage8bossc$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage8bossc$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage8bossc$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage8bossc$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage8bossc$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
