...
S:Lstage2endboss.UpdateStage2EndBoss2$en$1$54({2}DG,STenemy:S),B,1,4
S:Lstage2endboss.UpdateStage2EndBoss2$sloc0$1$0({2}DG,SC:U),B,1,-7
S:Lstage2endboss.UpdateStage2EndBoss2$sloc1$1$0({2}SI:S),B,1,-3
...
S:Lstage2endboss.UpdateStage2EndBoss1$en$1$57({2}DG,STenemy:S),B,1,4
F:G$UpdateStage2EndBoss3$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage2endboss.UpdateStage2EndBoss3$en$1$59({2}DG,STenemy:S),B,1,4
F:G$UpdateStage2EndBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage2endboss.UpdateStage2EndBoss$en$1$61({2}DG,STenemy:S),B,1,4
