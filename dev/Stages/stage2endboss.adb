...
S:Lstage2endboss.UpdateStage2EndBoss2$en$1$61({2}DG,STenemy:S),B,1,4
S:Lstage2endboss.UpdateStage2EndBoss2$sloc0$1$0({2}DG,SC:U),B,1,-3
S:Lstage2endboss.UpdateStage2EndBoss2$sloc1$1$0({2}SI:S),B,1,-5
S:Lstage2endboss.UpdateStage2EndBoss2$sloc2$1$0({2}SI:S),B,1,-7
S:Lstage2endboss.UpdateStage2EndBoss2$sloc3$1$0({1}SC:U),B,1,-1
F:G$UpdateStage2EndBoss1$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage2endboss.UpdateStage2EndBoss1$en$1$64({2}DG,STenemy:S),B,1,4
F:G$UpdateStage2EndBoss3$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage2endboss.UpdateStage2EndBoss3$en$1$66({2}DG,STenemy:S),B,1,4
F:G$UpdateStage2EndBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage2endboss.UpdateStage2EndBoss$en$1$68({2}DG,STenemy:S),B,1,4
T:Fstage2endboss$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
...
T:Fstage2endboss$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fstage2endboss$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage2endboss$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage2endboss$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage2endboss$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage2endboss$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
