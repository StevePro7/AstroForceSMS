M:stage4endboss
F:G$DoStage4EndBossSinusMovementVert$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4endboss.DoStage4EndBossSinusMovementVert$en$1$66({2}DG,STenemy:S),B,1,4
...
S:Lstage4endboss.UpdateStage4EndBoss1$en$1$70({2}DG,STenemy:S),B,1,4
S:Lstage4endboss.UpdateStage4EndBoss1$sloc0$1$0({2}DG,SC:U),B,1,-4
S:Lstage4endboss.UpdateStage4EndBoss1$sloc1$1$0({1}SC:U),B,1,-2
S:Lstage4endboss.UpdateStage4EndBoss1$sloc2$1$0({1}SC:U),B,1,-1
F:G$UpdateStage4EndBoss2$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4endboss.UpdateStage4EndBoss2$en$1$73({2}DG,STenemy:S),B,1,4
F:G$UpdateStage4EndBoss3$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4endboss.UpdateStage4EndBoss3$en$1$75({2}DG,STenemy:S),B,1,4
F:G$UpdateStage4EndBoss4$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4endboss.UpdateStage4EndBoss4$en$1$78({2}DG,STenemy:S),B,1,4
S:Lstage4endboss.UpdateStage4EndBoss4$sloc0$1$0({2}DG,SC:U),B,1,-2
F:G$UpdateStage4EndBoss5$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4endboss.UpdateStage4EndBoss5$en$1$81({2}DG,STenemy:S),B,1,4
F:G$UpdateStage4EndBoss6$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4endboss.UpdateStage4EndBoss6$en$1$83({2}DG,STenemy:S),B,1,4
F:G$UpdateStage4EndBoss7$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage4endboss.UpdateStage4EndBoss7$en$1$86({2}DG,STenemy:S),B,1,4
F:G$UpdateStage4EndBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage4endboss.UpdateStage4EndBoss$en$1$88({2}DG,STenemy:S),B,1,4
T:Fstage4endboss$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
T:Fstage4endboss$enemy[({0}S:S$enemyposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemytype$0$0({1}SC:U),Z,0,0)({3}S:S$enemyframe$0$0({1}SC:U),Z,0,0)({4}S:S$enemyparama$0$0({1}SC:U),Z,0,0)({5}S:S$enemyparamb$0$0({1}SC:U),Z,0,0)({6}S:S$enemyenergy$0$0({1}SC:U),Z,0,0)({7}S:S$enemywidth$0$0({1}SC:U),Z,0,0)({8}S:S$enemyheight$0$0({1}SC:U),Z,0,0)]
T:Fstage4endboss$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fstage4endboss$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage4endboss$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage4endboss$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage4endboss$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage4endboss$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
