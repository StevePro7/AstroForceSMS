...
S:Lstage7endboss.InitStage7EndBossB$en$1$54({2}DG,STenemy:S),B,1,4
F:G$InitStage7EndBoss$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstage7endboss.InitStage7EndBoss$en$1$56({2}DG,STenemy:S),B,1,4
S:Lstage7endboss.InitStage7EndBoss$a$1$57({1}SC:U),B,1,-3
...
S:Lstage7endboss.UpdateStage7EndBossB$en$1$63({2}DG,STenemy:S),B,1,4
