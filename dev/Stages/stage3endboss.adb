M:stage3endboss
F:G$DoStage3EndBossCrossShooting$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstage3endboss.DoStage3EndBossCrossShooting$en$1$53({2}DG,STenemy:S),B,1,4
S:Lstage3endboss.DoStage3EndBossCrossShooting$a$1$54({1}SC:U),R,0,0,[]
S:Lstage3endboss.DoStage3EndBossCrossShooting$b$1$54({1}SC:U),B,1,-5
S:Lstage3endboss.DoStage3EndBossCrossShooting$sloc0$1$0({2}DG,SC:U),B,1,-4
S:Lstage3endboss.DoStage3EndBossCrossShooting$sloc1$1$0({1}SC:U),B,1,-2
S:Lstage3endboss.DoStage3EndBossCrossShooting$sloc2$1$0({1}SC:U),B,1,-1
F:G$UpdateStage3EndBoss2$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage3endboss.UpdateStage3EndBoss2$en$1$57({2}DG,STenemy:S),B,1,4
F:G$UpdateStage3EndBoss1$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage3endboss.UpdateStage3EndBoss1$en$1$59({2}DG,STenemy:S),B,1,4
F:G$UpdateStage3EndBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage3endboss.UpdateStage3EndBoss$en$1$61({2}DG,STenemy:S),B,1,4
S:Lstage3endboss.UpdateStage3EndBoss$sloc0$1$0({1}SC:U),B,1,-2
S:Lstage3endboss.UpdateStage3EndBoss$sloc1$1$0({1}SC:U),B,1,-1
T:Fstage3endboss$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
T:Fstage3endboss$enemy[({0}S:S$enemyposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemytype$0$0({1}SC:U),Z,0,0)({3}S:S$enemyframe$0$0({1}SC:U),Z,0,0)({4}S:S$enemyparama$0$0({1}SC:U),Z,0,0)({5}S:S$enemyparamb$0$0({1}SC:U),Z,0,0)({6}S:S$enemyenergy$0$0({1}SC:U),Z,0,0)({7}S:S$enemywidth$0$0({1}SC:U),Z,0,0)({8}S:S$enemyheight$0$0({1}SC:U),Z,0,0)]
T:Fstage3endboss$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fstage3endboss$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage3endboss$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage3endboss$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage3endboss$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage3endboss$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
