...
S:Lstage3endboss.DoStage3EndBossCrossShooting$sloc1$1$0({1}SC:U),B,1,-4
...
S:Lstage3endboss.UpdateStage3EndBoss$sloc0$1$0({1}SC:U),B,1,-1
S:Lstage3endboss.UpdateStage3EndBoss$sloc1$1$0({1}SC:U),B,1,-2
