...
S:Lstage3star.InitStage3Star$st$1$79({2}DG,STstage3star:S),B,1,4
S:Lstage3star.InitStage3Star$speed$1$79({1}SC:U),B,1,6
F:G$UpdateStarMovement$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage3star.UpdateStarMovement$st$1$81({2}DG,STstage3star:S),B,1,4
F:G$UpdateStage3Star$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage3star.UpdateStage3Star$st$1$83({2}DG,STstage3star:S),B,1,4
F:G$UpdateStage5Cloud$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage3star.UpdateStage5Cloud$st$1$85({2}DG,STstage3star:S),B,1,4
...
T:Fstage3star$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage3star$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage3star$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage3star$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage3star$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
