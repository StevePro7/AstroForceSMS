M:stage5endboss
F:G$UpdateStage5EndBoss0$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage5endboss.UpdateStage5EndBoss0$en$1$63({2}DG,STenemy:S),B,1,4
F:G$UpdateStage5EndBoss1$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage5endboss.UpdateStage5EndBoss1$en$1$66({2}DG,STenemy:S),B,1,4
S:Lstage5endboss.UpdateStage5EndBoss1$a$1$67({1}SC:U),R,0,0,[d]
S:Lstage5endboss.UpdateStage5EndBoss1$sloc0$1$0({2}DG,STenemy:S),B,1,-2
F:G$UpdateStage5EndBoss2$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage5endboss.UpdateStage5EndBoss2$en$1$72({2}DG,STenemy:S),B,1,4
F:G$UpdateStage5EndBoss3$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage5endboss.UpdateStage5EndBoss3$en$1$75({2}DG,STenemy:S),B,1,4
S:Lstage5endboss.UpdateStage5EndBoss3$sloc0$1$0({2}DG,SC:U),B,1,-4
S:Lstage5endboss.UpdateStage5EndBoss3$sloc1$1$0({1}SC:U),B,1,-1
S:Lstage5endboss.UpdateStage5EndBoss3$sloc2$1$0({1}SC:U),B,1,-2
F:G$UpdateStage5EndBoss4$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage5endboss.UpdateStage5EndBoss4$en$1$79({2}DG,STenemy:S),B,1,4
F:G$UpdateStage5EndBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage5endboss.UpdateStage5EndBoss$en$1$82({2}DG,STenemy:S),B,1,4
T:Fstage5endboss$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
T:Fstage5endboss$enemy[({0}S:S$enemyposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemytype$0$0({1}SC:U),Z,0,0)({3}S:S$enemyframe$0$0({1}SC:U),Z,0,0)({4}S:S$enemyparama$0$0({1}SC:U),Z,0,0)({5}S:S$enemyparamb$0$0({1}SC:U),Z,0,0)({6}S:S$enemyenergy$0$0({1}SC:U),Z,0,0)({7}S:S$enemywidth$0$0({1}SC:U),Z,0,0)({8}S:S$enemyheight$0$0({1}SC:U),Z,0,0)]
T:Fstage5endboss$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fstage5endboss$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage5endboss$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage5endboss$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage5endboss$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage5endboss$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
