M:stage6endboss
F:G$FinishStage6EndBoss$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ResetSkullState$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.ResetSkullState$en$1$87({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.ResetSkullState$st$1$87({2}SI:U),B,1,6
S:Lstage6endboss.ResetSkullState$rec$1$87({1}SC:U),B,1,8
F:G$CreateCustomBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.CreateCustomBoneC$x$1$89({1}SC:U),B,1,4
S:Lstage6endboss.CreateCustomBoneC$y$1$89({1}SC:U),B,1,5
S:Lstage6endboss.CreateCustomBoneC$vx$1$89({1}SC:U),B,1,6
S:Lstage6endboss.CreateCustomBoneC$vy$1$89({1}SC:U),B,1,7
S:Lstage6endboss.CreateCustomBoneC$enm$1$90({2}DG,STenemy:S),R,0,0,[c,b]
F:G$LaunchSkullBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.LaunchSkullBoneC$en$1$91({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.LaunchSkullBoneC$vy$1$91({1}SC:U),B,1,6
S:Lstage6endboss.LaunchSkullBoneC$sloc0$1$0({1}SC:U),B,1,-1
S:Lstage6endboss.LaunchSkullBoneC$sloc1$1$0({1}SC:U),B,1,-2
F:G$DoSkullShootDirection$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.DoSkullShootDirection$en$1$94({2}DG,STenemy:S),B,1,4
F:G$DoSkullShootDirectionB$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.DoSkullShootDirectionB$en$1$96({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.DoSkullShootDirectionB$a$1$97({1}SC:U),R,0,0,[d]
S:Lstage6endboss.DoSkullShootDirectionB$sloc0$1$0({2}DG,SC:U),B,1,-3
S:Lstage6endboss.DoSkullShootDirectionB$sloc1$1$0({1}SC:U),B,1,-1
F:G$UpdateStage6EndBoss0$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss0$en$1$99({2}DG,STenemy:S),B,1,4
F:G$UpdateStage6EndBoss1$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss1$en$1$101({2}DG,STenemy:S),B,1,4
F:G$UpdateStage6EndBoss2$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss2$en$1$105({2}DG,STenemy:S),B,1,4
F:G$UpdateStage6EndBoss3$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss3$en$1$108({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.UpdateStage6EndBoss3$sloc0$1$0({2}DG,SC:U),B,1,-2
S:Lstage6endboss.UpdateStage6EndBoss3$sloc1$1$0({1}SC:U),B,1,-3
F:G$UpdateStage6EndBoss3A$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss3A$en$1$112({2}DG,STenemy:S),B,1,4
F:G$UpdateStage6EndBoss4$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss4$en$1$115({2}DG,STenemy:S),B,1,4
F:G$UpdateStage6EndBoss5$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss5$en$1$118({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.UpdateStage6EndBoss5$a$1$119({1}SC:U),R,0,0,[e]
S:Lstage6endboss.UpdateStage6EndBoss5$sloc0$1$0({2}DG,SC:U),B,1,-3
S:Lstage6endboss.UpdateStage6EndBoss5$sloc1$1$0({1}SC:U),B,1,-1
F:G$UpdateStage6EndBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss$en$1$121({2}DG,STenemy:S),B,1,4
T:Fstage6endboss$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
...
T:Fstage6endboss$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fstage6endboss$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fstage6endboss$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fstage6endboss$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fstage6endboss$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fstage6endboss$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
