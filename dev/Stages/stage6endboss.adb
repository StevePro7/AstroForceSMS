M:stage6endboss
F:G$stage6endboss_foo$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$CreateCustomBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.CreateCustomBoneC$x$1$53({1}SC:U),B,1,4
S:Lstage6endboss.CreateCustomBoneC$y$1$53({1}SC:U),B,1,5
S:Lstage6endboss.CreateCustomBoneC$vx$1$53({1}SC:U),B,1,6
S:Lstage6endboss.CreateCustomBoneC$vy$1$53({1}SC:U),B,1,7
S:Lstage6endboss.CreateCustomBoneC$enm$1$54({2}DG,STenemy:S),R,0,0,[c,b]
F:G$LaunchSkullBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.LaunchSkullBoneC$en$1$55({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.LaunchSkullBoneC$vy$1$55({1}SC:U),B,1,6
