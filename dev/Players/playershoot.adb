...
S:Lplayershoot.DrawPlayerShoot$ps$1$77({2}DG,STplayershoot:S),B,1,4
...
S:Lplayershoot.RemovePlayershoot$a$1$85({1}SC:S),B,1,4
S:Lplayershoot.RemovePlayershoot$psa$1$86({2}DG,STplayershoot:S),R,0,0,[c,b]
S:Lplayershoot.RemovePlayershoot$psb$1$86({2}DG,STplayershoot:S),R,0,0,[]
F:G$UpdatePlayershoot$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lplayershoot.UpdatePlayershoot$a$1$88({2}SI:U),B,1,4
S:Lplayershoot.UpdatePlayershoot$en$1$89({2}DG,STenemy:S),R,0,0,[e,d]
S:Lplayershoot.UpdatePlayershoot$b$1$89({1}SC:S),R,0,0,[b]
S:Lplayershoot.UpdatePlayershoot$ps$1$89({2}DG,STplayershoot:S),B,1,-4
S:Lplayershoot.UpdatePlayershoot$sloc0$1$0({2}SI:S),B,1,-2
F:G$UpdatePlayershoots$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.UpdatePlayershoots$a$1$98({1}SC:S),R,0,0,[]
F:G$InitPlayershoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.InitPlayershoot$x$1$100({1}SC:U),B,1,4
S:Lplayershoot.InitPlayershoot$y$1$100({1}SC:U),B,1,5
S:Lplayershoot.InitPlayershoot$t$1$100({1}SC:U),B,1,6
S:Lplayershoot.InitPlayershoot$ps$1$101({2}DG,STplayershoot:S),R,0,0,[c,b]
