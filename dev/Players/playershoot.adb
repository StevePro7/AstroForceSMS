...
S:Lplayershoot.DrawPlayerShoot$ps$1$87({2}DG,STplayershoot:S),B,1,4
...
S:Lplayershoot.UpdatePlayershoot$a$1$95({2}SI:U),B,1,4
S:Lplayershoot.UpdatePlayershoot$en$1$96({2}DG,STenemy:S),R,0,0,[e,d]
S:Lplayershoot.UpdatePlayershoot$b$1$96({1}SC:S),R,0,0,[b]
S:Lplayershoot.UpdatePlayershoot$ps$1$96({2}DG,STplayershoot:S),B,1,-4
S:Lplayershoot.UpdatePlayershoot$sloc0$1$0({2}SI:S),B,1,-2
F:G$UpdatePlayershoots$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.UpdatePlayershoots$a$1$105({1}SC:S),R,0,0,[]
F:G$InitPlayershoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.InitPlayershoot$x$1$107({1}SC:U),B,1,4
S:Lplayershoot.InitPlayershoot$y$1$107({1}SC:U),B,1,5
S:Lplayershoot.InitPlayershoot$t$1$107({1}SC:U),B,1,6
S:Lplayershoot.InitPlayershoot$ps$1$108({2}DG,STplayershoot:S),R,0,0,[c,b]
