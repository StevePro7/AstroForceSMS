...
S:Lplayershoot.DrawPlayerShoot$ps$1$95({2}DG,STplayershoot:S),B,1,4
...
S:Lplayershoot.UpdatePlayershoot$a$1$103({2}SI:U),B,1,4
S:Lplayershoot.UpdatePlayershoot$en$1$104({2}DG,STenemy:S),R,0,0,[e,d]
S:Lplayershoot.UpdatePlayershoot$b$1$104({1}SC:S),R,0,0,[b]
S:Lplayershoot.UpdatePlayershoot$ps$1$104({2}DG,STplayershoot:S),B,1,-4
S:Lplayershoot.UpdatePlayershoot$sloc0$1$0({2}SI:S),B,1,-2
F:G$UpdatePlayershoots$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.UpdatePlayershoots$a$1$113({1}SC:S),R,0,0,[]
F:G$InitPlayershoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.InitPlayershoot$x$1$115({1}SC:U),B,1,4
S:Lplayershoot.InitPlayershoot$y$1$115({1}SC:U),B,1,5
S:Lplayershoot.InitPlayershoot$t$1$115({1}SC:U),B,1,6
S:Lplayershoot.InitPlayershoot$ps$1$116({2}DG,STplayershoot:S),R,0,0,[c,b]
