...
S:Lplaystage.InitStageData$palette_bin$1$90({2}DG,SC:U),B,1,-8
S:Lplaystage.InitStageData$palette_bin_bank$1$90({2}SI:U),B,1,-10
S:Lplaystage.InitStageData$tilemap_l$1$90({2}DG,SC:U),B,1,-12
S:Lplaystage.InitStageData$tilemap_l_size$1$90({2}SI:U),B,1,-2
