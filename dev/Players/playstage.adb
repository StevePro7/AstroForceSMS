...
S:Lplaystage.InitStageSprite$b$1$65({1}SC:U),B,1,4
S:Lplaystage.InitStageSprite$pointer$1$66({2}DG,SC:U),R,0,0,[c,b]
S:Lplaystage.InitStageSprite$base$1$66({2}SI:S),R,0,0,[e,d]
S:Lplaystage.InitStageSprite$bank$1$66({1}SC:U),R,0,0,[h]
F:G$InitStageSprites$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplaystage.InitStageSprites$spl$1$67({2}DG,SC:U),B,1,4
S:Lplaystage.InitStageSprites$num$1$67({1}SC:U),B,1,6
S:Lplaystage.InitStageSprites$a$1$68({1}SC:U),R,0,0,[c]
F:G$InitCustomStageData$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitStageData$0$0({2}DF,SV:S),Z,0,12,0,0,0
S:Lplaystage.InitStageData$i$1$72({2}SI:U),B,1,4
S:Lplaystage.InitStageData$palette_bin$1$73({2}DG,SC:U),B,1,-6
S:Lplaystage.InitStageData$palette_bin_bank$1$73({2}SI:U),B,1,-4
S:Lplaystage.InitStageData$tilemap_l$1$73({2}DG,SC:U),B,1,-2
S:Lplaystage.InitStageData$tilemap_l_size$1$73({2}SI:U),B,1,-12
S:Lplaystage.InitStageData$tilemap_m$1$73({2}DG,SC:U),B,1,-8
S:Lplaystage.InitStageData$psg$1$73({2}DG,SC:U),R,0,0,[c,b]
S:Lplaystage.InitStageData$psg_bank$1$73({2}SI:U),B,1,-10
S:Lplaystage.InitStageData$loop_psg$1$73({1}SC:U),R,0,0,[e]
...
S:G$enemyshoot_foo$0$0({2}DF,SV:S),C,0,0
