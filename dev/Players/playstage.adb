...
S:Lplaystage.InitStageData$palette_bin_bank$1$123({2}SI:U),B,1,-4
S:Lplaystage.InitStageData$tilemap_l$1$123({2}DG,SC:U),B,1,-12
S:Lplaystage.InitStageData$tilemap_l_size$1$123({2}SI:U),B,1,-8
S:Lplaystage.InitStageData$tilemap_m$1$123({2}DG,SC:U),B,1,-10
