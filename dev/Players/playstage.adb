M:playstage
F:G$InitCustomStageData$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitStageData$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplaystage.InitStageData$i$1_0$62({2}SI:U),B,1,4
S:Lplaystage.InitStageData$palette_bin$1_0$63({2}DG,SC:U),R,0,0,[c,b]
S:Lplaystage.InitStageData$palette_bin_bank$1_0$63({2}SI:U),R,0,0,[]
S:Lplaystage.InitStageData$tilemap_l$1_0$63({2}DG,SC:U),B,1,-10
S:Lplaystage.InitStageData$tilemap_l_size$1_0$63({2}SI:U),B,1,-8
S:Lplaystage.InitStageData$tilemap_m$1_0$63({2}DG,SC:U),B,1,-6
S:Lplaystage.InitStageData$psg$1_0$63({2}DG,SC:U),B,1,-4
S:Lplaystage.InitStageData$psg_bank$1_0$63({2}SI:U),R,0,0,[]
S:Lplaystage.InitStageData$loop_psg$1_0$63({1}SC:U),B,1,-1
S:Lplaystage.InitStageData$sloc0$0_1$0({1}SC:U),B,1,-11
S:Lplaystage.InitStageData$sloc1$0_1$0({2}DG,SC:U),B,1,-10
S:Lplaystage.InitStageData$sloc2$0_1$0({2}SI:U),B,1,-8
S:Lplaystage.InitStageData$sloc3$0_1$0({2}DG,SC:U),B,1,-6
S:Lplaystage.InitStageData$sloc4$0_1$0({2}DG,SC:U),B,1,-4
S:Lplaystage.InitStageData$sloc5$0_1$0({1}SC:U),B,1,-2
S:Lplaystage.InitStageData$sloc6$0_1$0({1}SC:U),B,1,-1
...
S:G$RemoveExplosion$0_0$0({2}DF,SV:S),C,0,0
S:G$UpdateExplosion$0_0$0({2}DF,SV:S),C,0,0
S:G$InitExplosion$0_0$0({2}DF,SV:S),C,0,0
S:G$UpdateExplosions$0_0$0({2}DF,SV:S),C,0,0
S:G$InitExplosionSprite$0_0$0({2}DF,SV:S),C,0,0
S:G$InitExplosions$0_0$0({2}DF,SV:S),C,0,0
S:G$InitSpawnedExplosion$0_0$0({2}DF,SV:S),C,0,0
S:G$getTileAt$0_0$0({2}DF,SC:U),C,0,0
S:G$SetMapLines$0_0$0({2}DF,SV:S),C,0,0
S:G$SetStaticEnemies$0_0$0({2}DF,SV:S),C,0,0
S:G$DrawMap$0_0$0({2}DF,SV:S),C,0,0
S:G$InitMap$0_0$0({2}DF,SV:S),C,0,0
S:G$MoveMap$0_0$0({2}DF,SV:S),C,0,0
S:G$InitPowerupSprites$0_0$0({2}DF,SV:S),C,0,0
S:G$InitPowerups$0_0$0({2}DF,SV:S),C,0,0
...
S:G$playershoot_foo$0_0$0({2}DF,SV:S),C,0,0
S:G$InitPlayershoots$0_0$0({2}DF,SV:S),C,0,0
