...
S:Lplayer.CheckPlayerEnemyCollision$a$1$93({1}SC:U),R,0,0,[]
S:Lplayer.CheckPlayerEnemyCollision$en$1$93({2}DG,STenemy:S),R,0,0,[]
F:G$CheckPlayerEnemyshootCollision$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer.CheckPlayerEnemyshootCollision$a$1$97({1}SC:U),R,0,0,[]
S:Lplayer.CheckPlayerEnemyshootCollision$es$1$97({2}DG,STenemyshoot:S),R,0,0,[]
F:G$UpdatePlayerIndicators$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer.UpdatePlayerIndicators$a$1$101({1}SC:U),R,0,0,[c]
...
S:Lplayer.UpdatePlayerState3$t$1$124({1}SC:U),R,0,0,[]
