M:ww2plane
F:G$InitWW2Plane$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lww2plane.InitWW2Plane$en$1$52({2}DG,STenemy:S),B,1,4
S:Lww2plane.InitWW2Plane$pat$1$53({2}DG,SC:U),R,0,0,[e,d]
F:G$UpdateWW2Plane$0$0({2}DF,SC:U),Z,0,1,0,0,0
S:Lww2plane.UpdateWW2Plane$en$1$54({2}DG,STenemy:S),B,1,4
S:Lww2plane.UpdateWW2Plane$p$1$55({1}SC:U),B,1,-7
S:Lww2plane.UpdateWW2Plane$pat$1$55({2}DG,SC:U),R,0,0,[e,d]
S:Lww2plane.UpdateWW2Plane$sloc0$1$0({2}DG,SC:U),B,1,-2
S:Lww2plane.UpdateWW2Plane$sloc1$1$0({1}SC:U),B,1,-3
S:Lww2plane.UpdateWW2Plane$sloc2$1$0({2}DG,SC:U),B,1,-6
S:Lww2plane.UpdateWW2Plane$sloc3$1$0({1}SC:U),B,1,-4
...
T:Fww2plane$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fww2plane$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fww2plane$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fww2plane$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fww2plane$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
