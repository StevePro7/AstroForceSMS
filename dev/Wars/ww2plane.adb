...
S:Lww2plane.InitWW2Plane$en$1$51({2}DG,STenemy:S),B,1,4
S:Lww2plane.InitWW2Plane$pat$1$52({2}DG,SC:U),R,0,0,[e,d]
F:G$UpdateWW2Plane$0$0({2}DF,SC:U),Z,0,1,0,0,0
S:Lww2plane.UpdateWW2Plane$en$1$53({2}DG,STenemy:S),B,1,4
S:Lww2plane.UpdateWW2Plane$p$1$54({1}SC:U),B,1,-7
S:Lww2plane.UpdateWW2Plane$pat$1$54({2}DG,SC:U),R,0,0,[e,d]
