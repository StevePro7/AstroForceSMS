...
S:Lvulcantank.UpdateVulcanTankCommon$en$1$61({2}DG,STenemy:S),B,1,4
F:G$UpdateVulcanTankLeft$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lvulcantank.UpdateVulcanTankLeft$en$1$64({2}DG,STenemy:S),B,1,4
F:G$UpdateVulcanTankRight$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lvulcantank.UpdateVulcanTankRight$en$1$66({2}DG,STenemy:S),B,1,4
F:G$UpdateVulcanTankStop$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lvulcantank.UpdateVulcanTankStop$en$1$68({2}DG,STenemy:S),B,1,4
S:Lvulcantank.UpdateVulcanTankStop$a$1$69({1}SC:U),R,0,0,[h]
