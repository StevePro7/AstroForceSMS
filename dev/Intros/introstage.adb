M:introstage
F:G$introstage_foo$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lintrostage.InitIntroStage$intronum$1$77({1}SC:U),B,1,4
...
T:Fintrostage$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
