...
S:Lintrosideplayer.InitIntroSidePlayer$en$1$54({2}DG,STenemy:S),B,1,4
F:G$UpdateIntroSidePlayer$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lintrosideplayer.UpdateIntroSidePlayer$en$1$56({2}DG,STenemy:S),B,1,4
S:Lintrosideplayer.UpdateIntroSidePlayer$a$1$57({2}SI:U),R,0,0,[e,d]
