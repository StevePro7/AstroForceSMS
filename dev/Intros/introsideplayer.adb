...
S:Lintrosideplayer.InitIntroSidePlayer$en$1$45({2}DG,STenemy:S),B,1,4
F:G$UpdateIntroSidePlayer$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lintrosideplayer.UpdateIntroSidePlayer$en$1$47({2}DG,STenemy:S),B,1,4
S:Lintrosideplayer.UpdateIntroSidePlayer$a$1$48({2}SI:U),R,0,0,[e,d]
