...
S:Lwarning.InitWarning$en$1$45({2}DG,STenemy:S),B,1,4
F:G$UpdateWarning$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lwarning.UpdateWarning$en$1$47({2}DG,STenemy:S),B,1,4
S:Lwarning.UpdateWarning$s$1$48({2}SI:U),R,0,0,[c,b]
S:Lwarning.UpdateWarning$x$1$48({1}SC:U),R,0,0,[l]
S:Lwarning.UpdateWarning$y$1$48({1}SC:U),R,0,0,[e]
