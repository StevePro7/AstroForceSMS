...
S:Lscripter.RemoveScript$a$1$97({1}SC:S),B,1,4
S:Lscripter.RemoveScript$sa$1$98({2}DG,STscript:S),R,0,0,[c,b]
S:Lscripter.RemoveScript$sb$1$98({2}DG,STscript:S),R,0,0,[e,d]
...
S:Lscripter.UpdateScript$sa$1$101({1}SC:U),B,1,-11
...
S:Lscripter.UpdateScripts$q$1$107({1}SC:S),R,0,0,[]
