...
S:Lscripter.InitScript$scripter$1$57({2}DG,SC:U),B,1,4
S:Lscripter.InitScript$labels$1$57({2}DG,DG,SC:U),B,1,6
S:Lscripter.InitScript$sc$1$58({2}DG,STscript:S),R,0,0,[c,b]
F:G$RemoveScript$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscripter.RemoveScript$a$1$60({1}SC:S),B,1,4
S:Lscripter.RemoveScript$sa$1$61({2}DG,STscript:S),R,0,0,[c,b]
S:Lscripter.RemoveScript$sb$1$61({2}DG,STscript:S),R,0,0,[e,d]
S:Lscripter.RemoveScript$sloc0$1$0({2}SI:U),B,1,-2
F:G$UpdateScript$0$0({2}DF,SV:S),C,0,5,0,0,0
S:Lscripter.UpdateScript$a$1$63({1}SC:U),B,1,4
S:Lscripter.UpdateScript$sf$1$64({1}SC:U),B,1,-11
S:Lscripter.UpdateScript$ss$1$64({2}DG,SC:U),B,1,-13
S:Lscripter.UpdateScript$sa$1$64({1}SC:U),B,1,-9
S:Lscripter.UpdateScript$sb$1$64({1}SC:U),B,1,-10
S:Lscripter.UpdateScript$sc$1$64({1}SC:U),R,0,0,[e]
S:Lscripter.UpdateScript$sp$1$64({2}SI:U),R,0,0,[]
S:Lscripter.UpdateScript$scr$1$64({2}DG,STscript:S),R,0,0,[c,b]
...
S:Lscripter.UpdateScript$sloc3$1$0({2}SI:S),B,1,-4
F:G$UpdateScripts$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscripter.UpdateScripts$q$1$70({1}SC:S),R,0,0,[]
