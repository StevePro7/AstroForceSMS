...
S:Lscripter.InitScript$scripter$1$76({2}DG,SC:U),B,1,4
S:Lscripter.InitScript$labels$1$76({2}DG,DG,SC:U),B,1,6
S:Lscripter.InitScript$sc$1$77({2}DG,STscript:S),R,0,0,[c,b]
F:G$RemoveScript$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscripter.RemoveScript$a$1$79({1}SC:S),B,1,4
S:Lscripter.RemoveScript$sa$1$80({2}DG,STscript:S),R,0,0,[c,b]
S:Lscripter.RemoveScript$sb$1$80({2}DG,STscript:S),R,0,0,[e,d]
S:Lscripter.RemoveScript$sloc0$1$0({2}SI:U),B,1,-2
F:G$UpdateScript$0$0({2}DF,SV:S),Z,0,5,0,0,0
S:Lscripter.UpdateScript$a$1$82({1}SC:U),B,1,4
S:Lscripter.UpdateScript$sf$1$83({1}SC:U),B,1,-13
S:Lscripter.UpdateScript$ss$1$83({2}DG,SC:U),B,1,-11
S:Lscripter.UpdateScript$sa$1$83({1}SC:U),B,1,-9
S:Lscripter.UpdateScript$sb$1$83({1}SC:U),B,1,-12
S:Lscripter.UpdateScript$sc$1$83({1}SC:U),R,0,0,[e]
S:Lscripter.UpdateScript$sp$1$83({2}SI:U),R,0,0,[]
S:Lscripter.UpdateScript$scr$1$83({2}DG,STscript:S),R,0,0,[c,b]
...
S:Lscripter.UpdateScripts$q$1$89({1}SC:S),R,0,0,[]
