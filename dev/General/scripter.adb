...
S:Lscripter.InitScript$scripter$1$46({2}DG,SC:U),B,1,4
S:Lscripter.InitScript$labels$1$46({2}DG,DG,SC:U),B,1,6
S:Lscripter.InitScript$sc$1$47({2}DG,STscript:S),R,0,0,[c,b]
