...
S:Lscripter.InitScript$scripter$1$75({2}DG,SC:U),B,1,4
S:Lscripter.InitScript$labels$1$75({2}DG,DG,SC:U),B,1,6
S:Lscripter.InitScript$sc$1$76({2}DG,STscript:S),R,0,0,[c,b]
F:G$RemoveScript$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscripter.RemoveScript$a$1$78({1}SC:S),B,1,4
S:Lscripter.RemoveScript$sa$1$79({2}DG,STscript:S),R,0,0,[c,b]
S:Lscripter.RemoveScript$sb$1$79({2}DG,STscript:S),R,0,0,[e,d]
S:Lscripter.RemoveScript$sloc0$1$0({2}SI:U),B,1,-2
F:G$UpdateScript$0$0({2}DF,SV:S),Z,0,5,0,0,0
S:Lscripter.UpdateScript$a$1$81({1}SC:U),B,1,4
S:Lscripter.UpdateScript$sf$1$82({1}SC:U),B,1,-9
S:Lscripter.UpdateScript$ss$1$82({2}DG,SC:U),B,1,-13
S:Lscripter.UpdateScript$sa$1$82({1}SC:U),B,1,-10
S:Lscripter.UpdateScript$sb$1$82({1}SC:U),B,1,-11
S:Lscripter.UpdateScript$sc$1$82({1}SC:U),R,0,0,[e]
S:Lscripter.UpdateScript$sp$1$82({2}SI:U),R,0,0,[]
S:Lscripter.UpdateScript$scr$1$82({2}DG,STscript:S),R,0,0,[c,b]
S:Lscripter.UpdateScript$sloc0$1$0({2}DG,SC:U),B,1,-8
S:Lscripter.UpdateScript$sloc1$1$0({2}SI:U),B,1,-6
S:Lscripter.UpdateScript$sloc2$1$0({2}DG,DG,DG,SC:U),B,1,-4
S:Lscripter.UpdateScript$sloc3$1$0({2}SI:S),B,1,-2
F:G$UpdateScripts$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscripter.UpdateScripts$q$1$88({1}SC:S),R,0,0,[]
T:Fscripter$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
...
T:Fscripter$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fscripter$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fscripter$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fscripter$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
