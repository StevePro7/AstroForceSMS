...
S:Lskullbone.SkullAccelX$en$1$47({2}DG,STenemy:S),B,1,4
F:G$SkullAccelY$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.SkullAccelY$en$1$49({2}DG,STenemy:S),B,1,4
S:Lskullbone.SkullAccelY$sloc0$1$0({1}SC:U),B,1,-1
F:G$SkullBoneCMove$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.SkullBoneCMove$en$1$51({2}DG,STenemy:S),B,1,4
F:G$InitSkullBoneA$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.InitSkullBoneA$en$1$53({2}DG,STenemy:S),B,1,4
F:G$InitSkullBoneB$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.InitSkullBoneB$en$1$55({2}DG,STenemy:S),B,1,4
F:G$InitSkullBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.InitSkullBoneC$en$1$57({2}DG,STenemy:S),B,1,4
F:G$TestSkullOut$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lskullbone.TestSkullOut$en$1$59({2}DG,STenemy:S),B,1,4
F:G$UpdateSkullBoneAB$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lskullbone.UpdateSkullBoneAB$en$1$61({2}DG,STenemy:S),B,1,4
S:Lskullbone.UpdateSkullBoneAB$sloc0$1$0({2}DG,SC:U),B,1,-2
F:G$UpdateSkullBoneCMovement$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.UpdateSkullBoneCMovement$en$1$64({2}DG,STenemy:S),B,1,4
F:G$UpdateSkullBoneC$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lskullbone.UpdateSkullBoneC$en$1$67({2}DG,STenemy:S),B,1,4
T:Fskullbone$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
T:Fskullbone$enemy[({0}S:S$enemyposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemytype$0$0({1}SC:U),Z,0,0)({3}S:S$enemyframe$0$0({1}SC:U),Z,0,0)({4}S:S$enemyparama$0$0({1}SC:U),Z,0,0)({5}S:S$enemyparamb$0$0({1}SC:U),Z,0,0)({6}S:S$enemyenergy$0$0({1}SC:U),Z,0,0)({7}S:S$enemywidth$0$0({1}SC:U),Z,0,0)({8}S:S$enemyheight$0$0({1}SC:U),Z,0,0)]
T:Fskullbone$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fskullbone$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fskullbone$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fskullbone$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
T:Fskullbone$explosion[({0}S:S$explosionposx$0$0({1}SC:U),Z,0,0)({1}S:S$explosionposy$0$0({1}SC:U),Z,0,0)({2}S:S$explosionsprite$0$0({1}SC:U),Z,0,0)({3}S:S$explosiontype$0$0({1}SC:U),Z,0,0)]
T:Fskullbone$timeredlabel[({0}S:S$timeredlabely$0$0({1}SC:U),Z,0,0)({1}S:S$timeredlabelt$0$0({1}SC:U),Z,0,0)]
