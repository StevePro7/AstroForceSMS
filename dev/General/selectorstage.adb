...
S:Lselectorstage.UpdateSelectorMarks$selected_stage$1$84({1}SC:U),B,1,4
S:Lselectorstage.UpdateSelectorMarks$a$1$85({1}SC:U),B,1,-3
S:Lselectorstage.UpdateSelectorMarks$b$1$85({1}SC:U),B,1,-5
S:Lselectorstage.UpdateSelectorMarks$c$1$85({1}SC:U),B,1,-4
S:Lselectorstage.UpdateSelectorMarks$d$1$85({1}SC:U),R,0,0,[c]
...
S:Lselectorstage.InitSelectorStage$selected_stage$1$93({1}SC:U),R,0,0,[c]
S:Lselectorstage.InitSelectorStage$keyfree$1$93({1}SC:U),R,0,0,[b]
T:Fselectorstage$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
...
T:Fselectorstage$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fselectorstage$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fselectorstage$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
