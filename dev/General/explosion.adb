...
S:Lexplosion.RemoveExplosion$a$1$48({1}SC:S),B,1,4
S:Lexplosion.RemoveExplosion$exa$1$49({2}DG,STexplosion:S),R,0,0,[c,b]
S:Lexplosion.RemoveExplosion$exb$1$49({2}DG,STexplosion:S),R,0,0,[]
F:G$UpdateExplosion$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lexplosion.UpdateExplosion$a$1$51({2}SI:U),B,1,4
S:Lexplosion.UpdateExplosion$ex$1$52({2}DG,STexplosion:S),B,1,-4
S:Lexplosion.UpdateExplosion$sloc0$1$0({2}DG,SC:U),B,1,-2
F:G$InitExplosion$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lexplosion.InitExplosion$x$1$57({1}SC:U),B,1,4
S:Lexplosion.InitExplosion$y$1$57({1}SC:U),B,1,5
S:Lexplosion.InitExplosion$t$1$57({1}SC:U),B,1,6
S:Lexplosion.InitExplosion$ex$1$58({2}DG,STexplosion:S),R,0,0,[c,b]
F:G$UpdateExplosions$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lexplosion.UpdateExplosions$a$1$61({1}SC:S),R,0,0,[]
...
S:Lexplosion.InitSpawnedExplosion$x$1$68({1}SC:U),B,1,4
S:Lexplosion.InitSpawnedExplosion$y$1$68({1}SC:U),B,1,5
S:Lexplosion.InitSpawnedExplosion$w$1$68({1}SC:U),B,1,6
S:Lexplosion.InitSpawnedExplosion$h$1$68({1}SC:U),B,1,7
