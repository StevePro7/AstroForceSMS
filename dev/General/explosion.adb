M:explosion
F:G$RemoveExplosion$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lexplosion.RemoveExplosion$a$1$56({1}SC:S),B,1,4
S:Lexplosion.RemoveExplosion$exa$1$57({2}DG,STexplosion:S),R,0,0,[c,b]
S:Lexplosion.RemoveExplosion$exb$1$57({2}DG,STexplosion:S),R,0,0,[]
F:G$UpdateExplosion$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lexplosion.UpdateExplosion$a$1$59({2}SI:U),B,1,4
S:Lexplosion.UpdateExplosion$ex$1$60({2}DG,STexplosion:S),B,1,-4
S:Lexplosion.UpdateExplosion$sloc0$1$0({2}DG,SC:U),B,1,-2
F:G$InitExplosion$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lexplosion.InitExplosion$x$1$65({1}SC:U),B,1,4
S:Lexplosion.InitExplosion$y$1$65({1}SC:U),B,1,5
S:Lexplosion.InitExplosion$t$1$65({1}SC:U),B,1,6
S:Lexplosion.InitExplosion$ex$1$66({2}DG,STexplosion:S),R,0,0,[c,b]
F:G$UpdateExplosions$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lexplosion.UpdateExplosions$a$1$69({1}SC:S),R,0,0,[]
F:G$InitExplosionSprite$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitExplosions$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$InitSpawnedExplosion$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lexplosion.InitSpawnedExplosion$x$1$76({1}SC:U),B,1,4
S:Lexplosion.InitSpawnedExplosion$y$1$76({1}SC:U),B,1,5
S:Lexplosion.InitSpawnedExplosion$w$1$76({1}SC:U),B,1,6
S:Lexplosion.InitSpawnedExplosion$h$1$76({1}SC:U),B,1,7
T:Fexplosion$stage3star[({0}S:S$posx$0$0({1}SC:U),Z,0,0)({1}S:S$posy$0$0({1}SC:U),Z,0,0)({2}S:S$speed$0$0({1}SC:U),Z,0,0)]
...
T:Fexplosion$enemyshoot[({0}S:S$enemyshootposx$0$0({1}SC:U),Z,0,0)({1}S:S$enemyshootposy$0$0({1}SC:U),Z,0,0)({2}S:S$enemyshootvelx$0$0({1}SC:S),Z,0,0)({3}S:S$enemyshootvely$0$0({1}SC:S),Z,0,0)({4}S:S$enemyshoottype$0$0({1}SC:U),Z,0,0)]
T:Fexplosion$scroll[({0}S:S$scrolllock$0$0({2}SI:S),Z,0,0)({2}S:S$scrolltimes$0$0({2}SI:S),Z,0,0)({4}S:S$scrolljump$0$0({2}SI:S),Z,0,0)({6}S:S$scrollspeedx$0$0({2}SI:S),Z,0,0)({8}S:S$scrollspeedy$0$0({2}SI:S),Z,0,0)]
T:Fexplosion$script[({0}S:S$scripterpass$0$0({2}SI:U),Z,0,0)({2}S:S$scripterscript$0$0({2}DG,SC:U),Z,0,0)({4}S:S$scripterlabels$0$0({2}DG,DG,SC:U),Z,0,0)({6}S:S$scripterframe$0$0({1}SC:U),Z,0,0)({7}S:S$scripterloop$0$0({1}SC:S),Z,0,0)]
T:Fexplosion$playershoot[({0}S:S$playershootx$0$0({1}SC:U),Z,0,0)({1}S:S$playershooty$0$0({1}SC:U),Z,0,0)({2}S:S$playershoottype$0$0({1}SC:U),Z,0,0)({3}S:S$playershootvelx$0$0({1}SC:S),Z,0,0)({4}S:S$playershootvely$0$0({1}SC:U),Z,0,0)]
